...
<link rel="stylesheet" type="text/css" href="js/easyui/themes/default/easyui.css">
 ...
 <link rel="stylesheet" type="text/css" href="css/pyls.css">
   ...
   <body class="easyui-layout">
    ...
    <div id="log"   style="font-size:20px;"><img src="img/lguse.png" style="width:20px;height:20px;float:letf;margin:5x 5px 0px 0px;">您好，评审老师 | <a href="outServlet">退出</a></div>
        </div>
</div>
<div data-options="region:'center'" >
<table id="cklw"></table>
<div id="cx_tool" style="padding:5px; font-size:16px;">			
